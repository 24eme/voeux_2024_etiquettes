...
do
  ...
  echo "s|bouteille_brute_rouge.svg|data:image/svg+xml;base64,$BOUTEILLESVG_BASE64|" | sed -f - templates/fiche.html | sed "s/%CUVEE%/$CUVEE/" > generate/pages/$QRCODE.html
done
